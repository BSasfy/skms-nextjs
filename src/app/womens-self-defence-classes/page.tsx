  ...
  return (
    <main className="skms-page">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <section
          id="beginnersCourse"
          className="w-full border-b border-zinc-700 bg-zinc-900/50 pt-12 pb-8"
        >
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-4xl">
              <h2 className="mb-4 h-20 content-center text-center text-3xl font-extrabold text-white">
                Women Only Beginners Course –{" "}
                {womensSelfDefenceClasses.monthAndYear}
              </h2>

              <div className="mb-8 skms-card p-8 shadow-lg/30">
                <h3 className="mb-4 justify-self-center text-2xl font-bold text-red-400">
                ...
                <div className="mb-6 rounded-lg border border-zinc-700 bg-zinc-900/50 p-6">
                  <h4 className="mb-4 text-xl font-bold text-red-400">
                    Course details:
                  </h4>
                  <ul className="list-disc space-y-3 text-zinc-300 sm:pl-7">
                ...
                <div className="space-y-4 text-center">
                  ...
                  <Link
                    ...
                    className="inline-block rounded-lg bg-red-600 px-6 py-3 font-bold text-gray-50 transition-colors duration-200 hover:bg-red-600/80"
                  >
                    Book now
                  </Link>
      ...
      <section className="border-b border-zinc-700 pt-16 pb-8">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="rounded-lg bg-zinc-900/50 p-8">
              ...
              <ul className="mx-auto max-w-2xl space-y-3 text-left">
                <li className="flex items-start">
                  <span className="mr-3 font-bold skms-link">•</span>
                  <span>
            ...
            <p className="mb-4 text-lg">
              ...
              <a href="tel:07512027411" className="skms-link underline">
                07512027411
              </a>{" "}
              or at{" "}
              <a
                href="mailto:info@scotkravmaga.co.uk"
                className="skms-link underline"
              >
            ...
            <div className="text-center">
              <Link
                href={womensSelfDefenceClasses.ticketLink}
                className="inline-block flex-1 rounded-lg bg-red-600 px-6 py-3 font-bold text-gray-50 transition-colors duration-200 hover:bg-red-600/80"
              >
                Book Now!
              </Link>
            </div>
      ...
      {/* Footer Section */}
      <section className="bg-red-700 py-8 text-white">
